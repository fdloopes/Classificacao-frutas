...
def main(_):
    ...
    for group in grouped:
        for directory in ['Abacate','Abacaxi','Banana','Carambola','Coco','Goiaba','Kiwi','Laranja','Limão','Maçã Braeburn','Mamão','Manga','Maracujá','Nectarina','Pera','Pêssego','Pitaia','Tangerina']:
            path = os.path.join(os.getcwd(), FLAGS.image_dir + '{}/'.format(directory))
